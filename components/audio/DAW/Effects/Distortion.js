...
export default function Distortion({ width }) {
  ...
  }, [audioURL, addToEditHistory, wavesurferRef, distortionAmount, distortionType, distortionTone, distortionOutputGain, cutRegion]);
        ...
        <Col xs={12} sm={6} md={3} lg={2} className="mb-2">
          ...
          >
            <Dropdown.Toggle
              ...
              className="w-100"
            >
              {distortionTypes.find(t => t.key === distortionType)?.name || 'Overdrive'}
            </Dropdown.Toggle>
