...
function AudioTrack({ track, index, zoomLevel = 100 }) {
  ...
  useEffect(() => {
    ...
    // Removed the safety check that was causing race conditions
    // The MediaRecorder is created right before setIsRecording(true)
    // so this check was triggering incorrectly
