...
export class EnhancedSynth {
  ...
  playNote(midiNote, velocity = 1, time = 0, duration = null) {
    ...
    if (this.options.wavetable === 'strings') {
      ...
      // Use the WUULF4 inverted space-time synthesizer
      ...
      console.log(`EnhancedSynth: Playing note ${midiNote} with WUULF4`);
      return voice;
    }
    ...
    if (this.options.wavetable === 'brass') {
      ...
      // Use the WUULF3 formant-pulse synthesizer
      ...
      this.voices.set(midiNote, voice);
      console.log(`EnhancedSynth: Playing note ${midiNote} with WUULF3`);
      return voice;
    }
